...
const htmlContent = `
<html><head>
    <title>Confluence is Now Hosted in the Cloud</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Confluence is Now Hosted in the Cloud</h1>
        <p>We are excited to announce that Confluence is now hosted in the cloud for a better user experience.</p>
